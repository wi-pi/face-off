...
python stats.py whitebox_eval_casia-small_triplet_vgg-cw_li.csv li
...
python stats.py whitebox_eval_small_center-large_center_casia-cw_li.csv li
python stats.py whitebox_eval_small_center-large_center_vgg-cw_li.csv li
python stats.py whitebox_eval_small_center-large_triplet_vgg-cw_li.csv li
python stats.py whitebox_eval_small_center-small_triplet_vgg-cw_li.csv li
